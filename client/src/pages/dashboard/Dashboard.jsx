    ...
    <Card className="w-full p-2 Dashboard overflow-y-auto">
      ...
      <div className='flex flex-col md:flex-row gap-4 h-full '>
        ...
        <div className=' flex flex-col w-full h-full basis-3/5'>
          <Card className=" bg-dshcard hover:bg-dteal transition duration-500 mb-4 p-6 h-60 md:h-2/4 quiz flex flex-row items-center">
            <div >
              <h1 className="text-2xl md:text-3xl 2xl:text-5xl">Test Yourself</h1>
              <p className='text-lg md:text-xl pt-4'>Generate new topic of your choice using our AI powered topic generator</p>
          ...
          <Card className="bg-dshcard hover:bg-dpink transition duration-500 p-6 h-60 md:h-2/4 analytics flex flex-row items-center">
            <div className="">
              <h1 className="text-2xl md:text-3xl 2xl:text-5xl">Your Performance</h1>
              <p className='text-lg md:text-xl pt-4'>Generate new topic of tour choice using our AI powered topic generator</p>
